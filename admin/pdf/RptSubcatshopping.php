<?php 
	...
	$pdf = new Subcatshopping('L','mm','legal');
	$pdf->AliasNbPages();
	$pdf->AddPage();
	...
	while($row = $resultado->fetch_assoc() ){
		...
		$pdf->Cell(50,6,utf8_decode($row['categoryid']),1,0,'L');
		
		$pdf->Cell(80,6,utf8_decode($row['subcategory']),1,0,'L');
...
//		$pdf->Cell(30,6,utf8_decode($row['orderdate']),1,1,'L');
	...
	$pdf->Output(utf8_decode('Subcantegorias.pdf'), 'I');
