<?php 
	...
	$query = "SELECT orders.id_order, orders.fecha_add, orders.client_id, orders.total_neto, orders.descuento, orders.total, orders.metodo, orders.fecha_liqui, orders.user_add_id, user.id_user, user.nombre, client.id_client, client.nombre_cte
	          FROM orders 
	          INNER JOIN user 
	...
	$pdf->Cell(25,6,'Fcha. Vta',1,0,'C',1);
	...
	$pdf->Output(utf8_decode('Venta por Fechas.pdf'), 'I');
	#$pdf->Output('D');
