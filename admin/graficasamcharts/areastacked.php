...
<html>
    ...
    <head>
        ...
        <script>
            ...
            var chartData =<?php print datos_shoppingano(); ?>;
            ...
            AmCharts.ready(function () {
                ...
                graph.type = "line";
                graph.title = "Precio de todos los pedidos";
                graph.valueField = "pp";//estos campos hay que cambiar
                graph.lineAlpha = 0;
                ...
                graph = new AmCharts.AmGraph();
                graph.type = "line";
                graph.title = "Precio base de todos los pedidos";
                graph.valueField = "ppbd";//estos campos hay que cambiar
                graph.lineAlpha = 0;
                graph.fillAlphas = 0.6;
