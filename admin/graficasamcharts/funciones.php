<?php
	...
	define('USUARIO','root');         
	define('CLAVE','');               
	define('BBDD',"shopping");


	function datos_shoppingmes($ano){
		// ----------------------------------	
		...
		$sql = "SELECT sum(`productPrice`) as pp,sum(`productPriceBeforeDiscount`) as ppbd,YEAR(`postingDate`) as ano FROM products group by YEAR(`postingDate`) order by postingDate ASC";
		/*************************************************
	...
	function menu_provincias($activo=-1){
		...
		*/
		...
		while($fila=mysqli_fetch_assoc($resultado)){
			...
			print "<li><a href=\"$_SERVER[PHP_SELF]?prov=$fila[codigo]\" $marcado>$fila[nombre]</a></li>\n";
		}
		print "</ul>\n";
		 /*****************************************
		 5.-Liberamos memoria y cerramos la conexion
